...
const AboutUs = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute w-full md:bg-[url('../public/background-medium.jpg')] bg-[url('../public/background.jpg')] bg-cover md:bg-center bg-no-repeat h-screen top-0 left-0">
