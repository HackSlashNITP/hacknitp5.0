...
const Sponsors = () => {
  ...
  return (
    <div className="bg-black w-full bg-[url('../public/background.jpg')] bg-cover md:bg-fixed bg-no-repeat overflow-y-auto flex flex-col items-center justify-center gap-[0px] text-center text-5xl text-white font-space-grotesk">
      <Header />
